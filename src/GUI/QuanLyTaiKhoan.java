...
//        lbTitle.setPreferredSize(new Dimension(getWidth(), 30));
        ...
        panel.addTab("Nhân viên", Helper.resizeImg(new ImageIcon("img/emp-male.png"), 40), new NhanVienView());
        panel.addTab("Khách hàng", Helper.resizeImg(new ImageIcon("img/customer.png"), 40), new KhachHangGUI());
