...
//        ArrayList<LoaiDTO> dsl = loaiDAO.getall();
...
//        ArrayList<NhanVienDTO> dsnv = nhanVienDAO.getall();
////        if (dsnv != null) {
...
////            }
////        }
//        cmbNhanVienBan.addItem("Trần Dươpng Đắc Lộc");
//    }
//
...
//        ArrayList<product_DTO> dssp = null;
...
//
//            if (loaiSP.equals("0")) {
//                dssp = productDao.getAllProducts();
//            } else {
//                dssp = productBus.findByLoai(loaiSP);
//            }
//        } else {
//            dssp = productDao.getAllProducts();
//        }
//
//        for (product_DTO sp : dssp) {
//            Vector vec = new Vector();
//            vec.add(sp.getMaSP());
//            vec.add(sp.getTenSP());
//            vec.add(dcf.format(sp.getGiaBan()));
//            vec.add(dcf.format(sp.getSoLuong()));
//            vec.add(sp.getDvTinh());
////            vec.add(sp.get());
...
//                pro.capNhatSoLuongSP(key, -soLuong);
